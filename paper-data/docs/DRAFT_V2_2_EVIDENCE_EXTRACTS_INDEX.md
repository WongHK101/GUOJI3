# Route-B Draft v2.2 Frozen Evidence Extracts

The review ZIP contains only frozen source files needed to inspect the figures
and tables cited in the separate v2.2 manuscript. These copies are not new
results and must not be modified, extended, or used to restart experimental
development. V2.2 changes scientific exposition only; its figure inputs and
numerical evidence are unchanged from the approved V2.1 inventory.
