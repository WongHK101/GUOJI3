# Route-B Draft v2.1 Evidence Traceability Register

## Scope

This register is the provenance companion for `istf_kbs_jacobian_coverage_draft_v2_1.tex`. It records the only empirical artifacts cited by the separate v2.1 draft. Hashes are recomputed when the review package is assembled. The canonical `E:\GUOJI\elsarticle\istf_kbs.tex` is not an input or output of this draft.
